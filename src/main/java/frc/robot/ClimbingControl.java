...
public class ClimbingControl {
    ...
    private ClimbingControl() {
        ...
        armRotationSolenoid = new DoubleSolenoid(PneumaticsModuleType.CTREPCM,Parameters.CLIMBER_FORWARD_CHANNEL,
                Parameters.CLIMBER_REVERSE_CHANNEL);
        climberLock = new DoubleSolenoid(PneumaticsModuleType.CTREPCM,Parameters.CLIMBER_LOCK_FORWARD_CHANNEL,
                Parameters.CLIMBER_LOCK_REVERSE_CHANNEL);
